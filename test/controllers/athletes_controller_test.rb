...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { height: @athlete.height, name: @athlete.name, sport: @athlete.sport, weight: @athlete.weight } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { height: @athlete.height, name: @athlete.name, sport: @athlete.sport, weight: @athlete.weight } }
